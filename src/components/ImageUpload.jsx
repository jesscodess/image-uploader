...
const ImageUpload = () => {
    ...
    const uploadImageDisplay = async () => {
      ...
      // setAvatarURL(cachedURL); | CODE FOR CLIENT-SIDE ONLY
    ...
    return (
        <div className="relative h-96 w-96 m-8">
          ...
          <form id="form" encType='multipart/form-data'>
            <button type="submit" onClick={handleImageUpload} className="flex-center absolute bottom-12 right-14 h-9 w-9 rounded-full">
